...
//��������� ) �.�. ���� �� ���� 32- �����!!!
public class salsa20 implements StreamAlgorythms {
    /*
    public static final int crypto_core_salsa20_ref_OUTPUTBYTES = 64;
    public static final int crypto_core_salsa20_ref_INPUTBYTES = 16;
    public static final int crypto_core_salsa20_ref_CONSTBYTES = 16;
    public static final int crypto_stream_salsa20_ref_KEYBYTES = 32;
    public static final int crypto_stream_salsa20_ref_NONCEBYTES = 8;
*/
    ...
    //�������� ���� � ���������� �� � ��������
    static long cycling_Shift(int u, int c) {
        return (u << c) | (u >>> (32 - c));
    }

    //��� ����� �� ������ ���� �����
    //�� ��� ������� ���������� ������ �������� x[0]+2^8*x[1]+2^16*x[2]+2^24*x[3]
...
// m -  �� ������
// mlen  - ������� m
    //n , noffset have not understood yet
    //k - key
    ...
    public static int crypto_stream_xor(byte[] c, byte[] m, int mlen, byte[] n, int noffset, byte[] k) {
        ...
        // if the mas length null buy-buy
        if (mlen == 0)
            return 0;
        //�������� � inv[] 8 ����� �� n ��������� � noffset
        for (int i = 0; i < 8; ++i)
